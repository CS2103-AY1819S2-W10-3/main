...
import static seedu.equipmentmanager.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
import static seedu.equipmentmanager.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static seedu.equipmentmanager.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static seedu.equipmentmanager.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.equipmentmanager.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static seedu.equipmentmanager.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
...
import static seedu.equipmentmanager.testutil.TypicalIndexes.INDEX_SECOND_PERSON;
import static seedu.equipmentmanager.testutil.TypicalIndexes.INDEX_THIRD_PERSON;

import org.junit.Test;

import seedu.equipmentmanager.commons.core.index.Index;
import seedu.equipmentmanager.logic.commands.EditCommand;
import seedu.equipmentmanager.logic.parser.EditCommandParser;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, Address.MESSAGE_CONSTRAINTS); // invalid equipmentmanager
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + SERIAL_NUMBER_DESC_AMY + TAG_DESC_FRIEND;

        EditCommand.EditEquipmentDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + EMAIL_DESC_AMY + SERIAL_NUMBER_DESC_AMY;

        EditCommand.EditEquipmentDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_AMY).withSerialNumber(VALID_SERIAL_NUMBER_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + SERIAL_NUMBER_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + SERIAL_NUMBER_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB
    ...
    public void parse_resetTags_success() {
        ...
        EditCommand.EditEquipmentDescriptor descriptor = new EditPersonDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
