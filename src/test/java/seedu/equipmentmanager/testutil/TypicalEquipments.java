...
public class TypicalEquipments {
    ...
    public static final Equipment ANCHORVALECC = new EquipmentBuilder().withName("Anchorvale CC")
            ...
            .withPhone("64894959").withSerialNumber("X14D669807").withTags("NorthEast").build();
    public static final Equipment HWIYOHCC = new EquipmentBuilder().withName("Hwi Yoh CC")
            ...
            .withTags("urgent", "NorthEast").build();
    ...
    public static final Equipment JURONGREENCC = new EquipmentBuilder().withName("Jurong Green CC").withPhone("65671374")
            .withEmail("jgcc@gmail.com").withAddress("6 Jurong West Ave 1, Singapore 649520")
