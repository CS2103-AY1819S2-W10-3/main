...
import seedu.equipmentmanager.commons.util.InvalidationListenerManager;
import seedu.equipmentmanager.model.equipment.Equipment;
import seedu.equipmentmanager.model.equipment.UniqueEquipmentList;
import seedu.equipmentmanager.model.tag.Tag;

/**
 * Wraps all data at the equipmentmanager-book level
...
public class EquipmentManager implements ReadOnlyEquipmentManager {
    ...
    /**
     * Adds a equipment to the equipmentmanager book.
     * The equipment must not already exist in the equipmentmanager book.
     */
     ...
     * {@code key} must exist in the equipmentmanager book.
     */
    ...
    /**
     * Notifies listeners that the equipmentmanager book has been modified.
     */
