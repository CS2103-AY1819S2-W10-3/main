...
public class VersionedEquipmentManager extends EquipmentManager {
    ...
    /**
     * Restores the equipmentmanager book to its previous state.
     */
    public void undo() {
        if (!canUndo()) {
    ...
    /**
     * Restores the equipmentmanager book to its previously undone state.
     */
    public void redo() {
        if (!canRedo()) {
    ...
    /**
     * Returns true if {@code undo()} has equipmentmanager book states to undo.
     */
    ...
    /**
     * Returns true if {@code redo()} has equipmentmanager book states to redo.
     */
