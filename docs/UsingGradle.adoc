...
* **`guiTests`** +
<<<<<<< HEAD
Runs all tests in the `seedu.equipmentmanager.ui` and `systemtests` package
* **`nonGuiTests`** +
Runs all non-GUI tests in the `seedu.equipmentmanager`
=======
Runs all tests in the `seedu.equipment.ui` and `systemtests` package
* **`nonGuiTests`** +
Runs all non-GUI tests in the `seedu.equipment`
